...
class IndicatorsParser(object):
        ...
        return [
            ...
            },
            {
                ...
                "subIndicators": [
                    {
                        "SHCFigures": [
                            self.createSHC(row, "Number of institutional deliveries against to total number of deliveries"),
                        ],
    ...
    def getIndicatorJsonFromCsv(self, csv_file_name):
...
if __name__ == '__main__':
    ...
    if len(sys.argv) <= 1:
        ...
        sys.exit(0)
    indicator.getIndicatorJsonFromCsv(sys.argv[1])